...
class _PaymentPageState extends StateMVC<PaymentPage> {
  ...
  void initState() {
    super.initState();
    widget.request.packageId != null ? setPackage() : null;
  }
  ...
  Widget build(BuildContext context) {
    bool order = widget.request.packageId != null;
    return Scaffold(
      key: con.scaffoldKey,
      appBar: BlackAppBar(
        title: const Text(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: mainHeading(context,
                          order ? "Payment Options" : "Payment Methods"),
                    ),
                    Visibility(
                      visible: order,
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Visibility(
                            ...
                            child: CardInputForm(
                              amount: widget.request.postFee ?? 100.0,
                              payNow: (Payment payment) {
                                con.createOrder(
                                    widget.request, package!, payment);
                              },
                            )),
                        const SizedBox(height: 10),
                        Visibility(
                        ...
                        child: Row(
                          children: <Widget>[
                            Container(
                              ...
                              padding: const EdgeInsets.all(8),
                              child: Image.asset("assets/icons/${e['icon']}",
                                  height: 28),
                            ),
                            const SizedBox(width: 10),
                            Flexible(
