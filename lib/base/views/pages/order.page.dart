              ...
              children: [
                Row(
                  children: <Widget>[
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(package!.images![0]),
                            fit: BoxFit.cover,
                          ),
                          border: Border.all(
                              width: 1.2,
                    ...
                    Visibility(
                      visible: package!.images!.length > 1,
                      child: Expanded(
                        child: Column(
                          children: <Widget>[
                            Container(
                              height: getHeight(context,
                                  package!.images!.length > 2 ? 14.5 : 30),
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(5),
                                image: DecorationImage(
                                  image: NetworkImage(package!.images![1]),
                                  fit: BoxFit.cover,
                                ),
                                border: Border.all(
                                    width: 1.2,
                            ...
                            Visibility(
                              visible: package!.images!.length > 2,
                              child: Container(
                                height: getHeight(context, 14.5),
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(5),
                                  image: DecorationImage(
                                    image: NetworkImage(package!.images![2]),
                                    fit: BoxFit.cover,
                                  ),
                                  border: Border.all(
                                      width: 1.2,
                ...
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      detailsItem("Address",
                          package!.destinationAddress!.address!.nameAddress),
                ...
                Row(
                  ...
                  children: <Widget>[
                    Expanded(
                        child: postManButton(
                            "Decline", false, () => Navigator.pop(context))),
                    const SizedBox(width: 10),
                    Expanded(
